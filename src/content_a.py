...
W01 = [
    ...
    table("Assessment", ["Component", "Weight", "Kind"], [
        ["Project", "55%", "Group of 3, with individual defence"],
        ["Test #1 (week 6)", "15%", "Individual, multiple choice"],
        ["Test #2 (week 11)", "20%", "Individual, in the IDE"],
        ["Code review exercise", "5%", "Individual"],
    ...
    bullets("The project, in one slide", [
        ...
        "Every member defends the code at the final delivery",
    ]),
    q("Why a game?"),
    ...
    bullets("The policy", [
        ...
        "Test #2 is closed-assistant &mdash; no internet, no models",
    ]),
    ...
    bullets("Where to find us", [
        ...
        "<strong>LDTS Clinic</strong> &mdash; TA hours for project help, from week 8",
